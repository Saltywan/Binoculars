...
import gradio as gr
from binoculars import Binoculars2
...
capybara_problem = '''ดร. คาปี คอสมอส ซึ่งเป็นคาปิบาราที่ไม่เหมือนใคร ทำให้ชุมชนวิทยาศาสตร์ประหลาดใจด้วยงานวิจัยที่ก้าวล้ำในสาขาฟิสิกส์ดาราศาสตร์ ด้วยความรู้สึกเฉียบแหลมในการสังเกตและความสามารถที่เหนือชั้นในการตีความข้อมูลจักรวาล เขาได้ค้นพบข้อมูลเชิงลึกใหม่ๆ เกี่ยวกับความลึกลับของหลุมดำและต้นกำเนิดของจักรวาล ขณะที่เขามองผ่านกล้องโทรทรรศน์ด้วยดวงตากลมโต เพื่อนนักวิจัยมักตั้งข้อสังเกตว่าดูเหมือนดวงดาวกระซิบความลับกับเขาโดยตรง ดร.คอสมอสไม่เพียงแต่เป็นแสงสว่างแห่งแรงบันดาลใจให้กับนักวิทยาศาสตร์ผู้มุ่งมั่นเท่านั้น แต่ยังพิสูจน์ให้เห็นว่าสติปัญญาและนวัตกรรมสามารถพบได้ในสิ่งมีชีวิตที่คาดไม่ถึงที่สุด'''
